...
int main(int argc, char * argv[]){
    ...
    if(argc == 1){
        ...
        if(argv[1] == parametroAleatorio){
            ...
            string nombreFicheroSalida = string("datos/tablero") + "-num-per=" + to_string(numero_de_personajes) + ".csv";
        ...
        cout << "\tJugar en Modo Grafico : ./bin/quienesquien ./datos/personajes_graficos.csv ./datos/Tapada.png" << endl;
        return 1;
    }
    ...
    char respuesta;
    cout << "¿Quieres añadir un personaje? (s/n): ";
    cin >> respuesta;

    if (respuesta == 's' || respuesta == 'S') {
        quienEsQuien.interactuar_agregar_personaje();
    }
