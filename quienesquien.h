...
public:
	...
	*/
    ...
    std::string preguntas_formuladas(bintree<Pregunta>::node jugada);
    
    void aniade_personaje(std::string nombre, std::vector<bool> caracteristicas, std::string nombre_imagen_personaje = "");
    
    void interactuar_agregar_personaje();
